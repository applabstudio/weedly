...
gulp.task('css', () =>
  gulp
    .src(path.join(config.root.dev, config.css.dev, 'main.scss'))
    .pipe(gulpif(!(mode.mode === 'production'), sourcemaps.init()))
    ...
    .pipe(gulpif(!(mode.mode === 'production'), sourcemaps.write()))
